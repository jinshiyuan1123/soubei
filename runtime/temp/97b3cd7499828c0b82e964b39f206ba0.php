<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy2016\WWW\soubei\public/../application/index\view\index\index.html";i:1545013690;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <link href="/soubei/public/assets/css/index.css" rel="stylesheet">
    ...
    <body id="page-top">
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <a class="navbar-brand page-scroll" href="#page-top"><img src="/soubei/public/assets/img/logo.png" style="width:200px;" alt=""></a> -->
                </div>

                <div class="collapse navbar-collapse" id="navbar-collapse-menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="souAdmin" target="_blank"><?php echo __('Home'); ?></a></li>
                        <li><a href="souAdmin/store.html" target="_blank"><?php echo __('Store'); ?></a></li>
                        <li><a href="souAdmin/wxapp.html" target="_blank"><?php echo __('Wxapp'); ?></a></li>
                        <li><a href="souAdmin/service.html" target="_blank"><?php echo __('Services'); ?></a></li>
                        <li><a href="souAdmin/download.html" target="_blank"><?php echo __('Download'); ?></a></li>
                        <li><a href="souAdmin/demo.html" target="_blank"><?php echo __('Demo'); ?></a></li>
                        <li><a href="souAdmin/donate.html" target="_blank"><?php echo __('Donation'); ?></a></li>
        ...
        <footer>
            <div class="container">
                ...
                <p>&copy; 2017-2018 <a href="souAdmin" target="_blank">SouAdmin</a>. All Rights Reserved.</p>
                <ul class="list-inline">
                   <!--  <li>
                    ...
                    <li>
                        <a href=""><?php echo __('QQ group'); ?>:932192032</a>
                    </li>
                </ul>
            </div>
        </footer>
